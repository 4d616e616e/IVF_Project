      ...
      case 0:
        return (
          <Box sx={{ py: 8 }}>
            ...
            >
              നമുക്ക് കാര്യങ്ങൾ നിങ്ങൾക്കനുസരിച്ച് വ്യക്തിഗതമാക്കാം.
            </Typography>
            <Typography sx={{ color: "#717171", fontSize: "20px", mb: "32px" }}>
              ഒരു മിനിറ്റിൽ കുറവാണ് വേണ്ടത്. ഈ അനുഭവം മുഴുവനായി
              നിങ്ങളെക്കുറിച്ചായിരിക്കട്ടെ.
            </Typography>
            <Button
              variant="outlined"
              fullWidth
      ...
      case 1:
        return (
          <Box sx={{ py: 4 }}>
            ...
            >
              നിങ്ങൾ എത്ര കാലമായി ഒരു കുഞ്ഞിനായി ശ്രമിക്കുന്നു?
            </Typography>
      ...
      case 2:
        return (
          <Box sx={{ py: 4 }}>
            ...
            >
              നിങ്ങൾ ഒരു ജോലിക്കാരായ ദമ്പതികളാണോ?
            </Typography>
            <RadioGroup
            ...
            {formData.workingCouple === "yes" && (
              <Box>
                <StyledTextBox
                  fullWidth
                  placeholder="നിങ്ങളുടെ അവസ്ഥ വിവരിക്കൂ (ഐച്ഛികം)"
        ...
        return (
          <Box sx={{ py: 4 }}>
            <Typography
              ...
              sx={{ mb: 4, fontWeight: 500 }}
            >
              നിങ്ങൾക്ക് മുൻപ് ഗർഭധാരണങ്ങളോ, ഗർഭം അലസലുകളോ, അല്ലെങ്കിൽ
              ഏതെങ്കിലും വന്ധ്യതാ ചികിത്സകളോ ഉണ്ടായിട്ടുണ്ടോ?
            </Typography>
            <RadioGroup
        ...
        return (
          <Box sx={{ py: 4 }}>
            <Typography
              ...
              sx={{ mb: 4, fontWeight: 500 }}
            >
              സ്ത്രീ പങ്കാളിക്ക് PCOS, എൻഡോമെട്രിയോസിസ്, അല്ലെങ്കിൽ തൈറോയ്ഡ്
              പോലുള്ള ആരോഗ്യ പ്രശ്നങ്ങളുണ്ടോ?
            </Typography>
            <RadioGroup
        ...
        return (
          <Box sx={{ py: 4 }}>
            <Typography
              ...
              sx={{ mb: 4, fontWeight: 500 }}
            >
              പുരുഷ പങ്കാളി ഇതിന് മുൻപ് ബീജ പരിശോധന നടത്തിയിട്ടുണ്ടോ?
            </Typography>
            <RadioGroup
        ...
        return (
          <Box sx={{ py: 4 }}>
            <Typography
              ...
              sx={{ mb: 4, fontWeight: 500 }}
            >
              നിങ്ങളുടെ കുടുംബത്തിൽ ആർക്കെങ്കിലും ജനിതക രോഗമോ ദീർഘകാല രോഗമോ
              ഉണ്ടോ?
            </Typography>
            <RadioGroup
