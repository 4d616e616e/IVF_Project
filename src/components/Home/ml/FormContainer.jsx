      ...
      <Container maxWidth="md" sx={{ my: "75px" }}>
        ...
        >
          <Typography
            ...
            className="font-400"
          >
            <span className="font-700">ഒരു</span> ലളിതമായ ചുവടോടെ ആരംഭിക്കുക!
          </Typography>
          ...
          >
            <Grid container spacing={1.6}>
              ...
              <Grid item size={{ xs: 12, sm: 6 }}>
                <InputLabel>ഫോൺ നമ്പർ</InputLabel>
                <InputBase
                  fullWidth
                  type="tel"
              ...
              <Grid item size={6}>
                <InputLabel>പുരുഷൻ പ്രായം</InputLabel>
                <InputBase
                  fullWidth
                  type="text"
              ...
              <Grid item size={6}>
                <InputLabel>സ്ത്രീ പ്രായം</InputLabel>
                <InputBase
                  fullWidth
                  type="text"
