      ...
      case 0:
        return (
          <Box sx={{ py: 8 }}>
            ...
            >
              चलिए इस अनुभव को आपके लिए पर्सनल बनाते हैं।
            </Typography>
            <Typography sx={{ color: "#717171", fontSize: "20px", mb: "32px" }}>
              सिर्फ एक मिनट लगेगा, ताकि यह सफर पूरी तरह आपके मुताबिक हो सके।
            </Typography>
            <Button
              variant="outlined"
              fullWidth
          ...
          <Box sx={{ py: 4 }}>
            ...
            {formData.workingCouple === "yes" && (
              <Box>
                <StyledTextBox
                  fullWidth
                  placeholder="अपनी स्थिति का वर्णन करें (वैकल्पिक)"
        ...
        return (
          <Box sx={{ py: 4 }}>
            <Typography
              ...
              sx={{ mb: 4, fontWeight: 500 }}
            >
              क्या पहले कभी गर्भधारण, गर्भपात या कोई फर्टिलिटी ट्रीटमेंट हुआ
              है?*
            </Typography>
            <RadioGroup
        ...
        return (
          <Box sx={{ py: 4 }}>
            <Typography
              ...
              sx={{ mb: 4, fontWeight: 500 }}
            >
              क्या महिला पार्टनर को कोई स्वास्थ्य समस्या है, जैसे PCOS,
              एंडोमेट्रिओसिस या थायरॉइड?
            </Typography>
            <RadioGroup
        ...
        return (
          <Box sx={{ py: 4 }}>
            <Typography
              ...
              sx={{ mb: 4, fontWeight: 500 }}
            >
              क्या पुरुष पार्टनर ने पहले कभी स्पर्म टेस्ट करवाया है?
            </Typography>
            <RadioGroup
        ...
        return (
          <Box sx={{ py: 4 }}>
            <Typography
              ...
              sx={{ mb: 4, fontWeight: 500 }}
            >
              क्या आपके परिवार में किसी को कोई जेनेटिक बीमारी या पुरानी
              स्वास्थ्य समस्या है?
            </Typography>
            <RadioGroup
